            ...
            <div class="col-8">
                   <div class="card">
                       ...
                       <div class="card-footer text-muted">
                           <button type="submit" class="btn btn-primary float-left" > <a href="/results/{{$students->id}}/create" class="text-light">Make Result</a> </button>
                           <button type="submit" class="btn btn-primary float-right" > <a href="/results/{{$students->id}}/grade" class="text-light">view Grade</a> </button>
